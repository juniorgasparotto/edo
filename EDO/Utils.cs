...
namespace EDO
{
    public class Utils
    {
        ...
        public static string ToExpression(HierarchicalEntity entity, Func<HierarchicalEntity, string> viewFunc, TokenizeType tokenizeType = TokenizeType.Normal)
        {
        ...
        public static string ToExpression(ListOfHierarchicalEntity entities, Func<HierarchicalEntity, string> viewFunc, TokenizeType tokenizeType = TokenizeType.Normal, string delimiterMainTokens = "\r\n")
        {
            var converterToToken = new HierarchicalEntityToToken(viewFunc, tokenizeType);
        ...
        public static string ToHierarchy(HierarchicalEntity entity, Func<HierarchicalEntity, string> viewFunc, TokenizeType tokenizeType = TokenizeType.Normal)
        {
            var converterToToken = new HierarchicalEntityToToken(viewFunc, tokenizeType);
        ...
        public static string ToHierarchy(List<HierarchicalEntity> entities, Func<HierarchicalEntity, string> viewFunc, TokenizeType tokenizeType = TokenizeType.Normal)
        {
            var converterToToken = new HierarchicalEntityToToken(viewFunc, tokenizeType);
            var converterToString = new TokenToHierarchy(viewFunc, CanIgnoreSubTokens(tokenizeType));
        ...
        public static string ToHierarchyInverse(HierarchicalEntity entity, Func<HierarchicalEntity, string> viewFunc, TokenizeType tokenizeType = TokenizeType.Normal)
        {
            var converterToToken = new HierarchicalEntityToToken(viewFunc, tokenizeType);
        ...
        public static string ToHierarchyInverse(List<HierarchicalEntity> entities, Func<HierarchicalEntity, string> viewFunc, TokenizeType tokenizeType = TokenizeType.Normal)
        {
            var converterToToken = new HierarchicalEntityToToken(viewFunc, tokenizeType);
            var converterToExp = new TokenToHierarchyInverse(viewFunc);
        ...
        public static string ToDebug(HierarchicalEntity entity, Func<HierarchicalEntity, string> viewFunc, TokenizeType tokenizeType = TokenizeType.Normal)
        {
            var converterToToken = new HierarchicalEntityToToken(viewFunc, tokenizeType);
        ...
        public static string ToDebug(List<HierarchicalEntity> entities, Func<HierarchicalEntity, string> viewFunc, TokenizeType tokenizeType = TokenizeType.Normal)
        {
            var converterToToken = new HierarchicalEntityToToken(viewFunc, tokenizeType);
            var converterToString = new TokenToDebug(viewFunc, CanIgnoreSubTokens(tokenizeType));
